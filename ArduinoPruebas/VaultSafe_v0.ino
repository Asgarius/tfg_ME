...
const String SecureCode = "1111";
const int blockAlarm = 8;   //Input de la pasarela
const int disableAlarm = 9;  //Output de la pasarela
const int PIRPin= 7; //Sensor PIR

//bool _PIRPin = digitalRead(PIRPin);  //Sensor de Proximidad/Presencia // Variable para el sensor de Proximidad que se inserte más adelante.
bool _blockAlarm = digitalRead(blockAlarm);
int contador = 0;
